...
" QSlider::groove:horizontal {border: 1px solid #999999; height: 8px; margin: 2px 0;}\
  QSlider::handle {background: #808000;border: 1px solid #5c0000; width: 18px; height: 18px; margin: -10px 0;  border-radius: 3px;}\
  QSlider::groove:vertical {border: 1px solid #999999; width: 8px; margin: 0 2px;}\
  QSlider::handle:vertical {background: #5c0000;border: 1px solid #5c5c5c; height: 18px; width: 18px; margin: 0 -10px;  border-radius: 3px;}\
";
