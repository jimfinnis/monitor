...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Apr 9 11:44:35 2013
# Project:  monitor.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		widgets/status.cpp \
		widgets/switch.cpp \
		widgets/map.cpp moc_qcommandline.cpp \
		moc_udp.cpp \
		moc_statusBlock.cpp \
		moc_gauge.cpp \
		moc_number.cpp \
...
compiler_moc_header_make_all: moc_qcommandline.cpp moc_udp.cpp moc_statusBlock.cpp moc_gauge.cpp moc_number.cpp moc_compass.cpp moc_compassPanel.cpp moc_graph.cpp moc_status.cpp moc_switch.cpp moc_map.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qcommandline.cpp moc_udp.cpp moc_statusBlock.cpp moc_gauge.cpp moc_number.cpp moc_compass.cpp moc_compassPanel.cpp moc_graph.cpp moc_status.cpp moc_switch.cpp moc_map.cpp
