...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu Apr 4 13:21:28 2013
# Project:  monitor.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile monitor.pro
#############################################################################
...
INCPATH       = -I/usr/lib64/qt4/mkspecs/linux-g++ -I. -I/usr/include/QtCore -I/usr/include/QtNetwork -I/usr/include/QtGui -I/usr/include -I/usr/include/marble -I. -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib64 -lrt -L/usr/local/lib -lmarblewidget -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: monitor.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
moc_app.cpp: udp.h \
		app.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) app.h -o moc_app.cpp

moc_qcommandline.cpp: qcommandline.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) qcommandline.h -o moc_qcommandline.cpp

moc_udp.cpp: udp.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) udp.h -o moc_udp.cpp

moc_statusBlock.cpp: widgets/statusBlock.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/statusBlock.h -o moc_statusBlock.cpp
...
moc_gauge.cpp: datarenderer.h \
		...
		tokeniser.h \
		widgets/gauge.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/gauge.h -o moc_gauge.cpp
...
moc_number.cpp: datarenderer.h \
		...
		tokeniser.h \
		widgets/number.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/number.h -o moc_number.cpp
...
moc_compass.cpp: datarenderer.h \
		...
		tokeniser.h \
		widgets/compass.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/compass.h -o moc_compass.cpp
...
moc_compassPanel.cpp: widgets/compass.h \
	...
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/compassPanel.h -o moc_compassPanel.cpp
...
moc_graph.cpp: datarenderer.h \
		...
		tokeniser.h \
		widgets/graph.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/graph.h -o moc_graph.cpp
...
moc_status.cpp: widgets/statusBlock.h \
		...
		exception.h \
		widgets/status.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/status.h -o moc_status.cpp
...
moc_switch.cpp: datarenderer.h \
		...
		udp.h \
		widgets/switch.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/switch.h -o moc_switch.cpp
...
moc_map.cpp: datarenderer.h \
		...
		tokeniser.h \
		widgets/map.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) widgets/map.h -o moc_map.cpp
